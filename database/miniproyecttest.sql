...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 23-10-2023 a las 19:24:57
...
CREATE TABLE `cursos` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `id_maestros` bigint(20) UNSIGNED NOT NULL,
...
(2, '2023_10_23_150009_create_docentes_table', 1),
(3, '2023_10_23_150017_create_alumnos_table', 1),
(4, '2023_10_23_150026_create_cursos_table', 1),
(5, '2023_10_23_150108_create_matriculas_table', 1),
(6, '2023_10_23_150120_create_asistencias_table', 1);
...
ALTER TABLE `cursos`
  ADD PRIMARY KEY (`id`),
  ADD KEY `cursos_id_maestros_foreign` (`id_maestros`);
...
--
ALTER TABLE `cursos`
  ADD CONSTRAINT `cursos_id_maestros_foreign` FOREIGN KEY (`id_maestros`) REFERENCES `docentes` (`id`);
